        ...
        for symbol in symbols:
            ...
            if data and isinstance(data, list) and data:
                ...
                if isinstance(profile, dict):
                    ...
                    # keys this skill's caller reads (analyze_earnings_trades.py
                    # profile.get("mktCap")/profile.get("exchangeShortName")),
                    # matching the alias canslim-screener's get_profile() already
                    # applies for the same rename.
